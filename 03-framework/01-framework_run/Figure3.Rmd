...
library(ggupset)
library(tidyverse)
processed_zoe_files <- readRDS('../../../data/processed/03-framework/01-framework_run/results_231010.processedcomotif.tcellspecific.RDS')
processed_izoe_files <- readRDS('../../../data/processed/03-framework/01-framework_run/results_231030.processedcomotif.bottomranked.RDS')
