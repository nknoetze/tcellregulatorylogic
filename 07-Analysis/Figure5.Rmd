...
ditypic_results <- fread('/projects/nknoetze_prj/ocr_prj/results/test_run/STARR-seq/ditypic.results.tsv') %>%
...
monotypic_counts <- process_counts('/projects/nknoetze_prj/ocr_prj/results/test_run/STARR-seq/candidate.master.count.file.tsv',type='single') %>% filter(cell=="Jurkat") %>%
  mutate(motif=gsub("PCA_","",motif))
ditypic_counts <- process_counts('/projects/nknoetze_prj/ocr_prj/results/test_run/STARR-seq/candidate.master.count.file.tsv',type='pair') %>% filter(cell=="Jurkat") %>%
  mutate(motif=gsub("PCA_","",motif))
